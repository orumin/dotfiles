...
XDG_CONFIGS	   = bat btop firenvim fish glamour mpv nvim nushell powershell skk starship.toml tmux vale wezterm
...
#	mkdir $(LOCALAPPDATA)\clink
	...
	make link SOURCE:="$(abspath nushell)" TARGET:="$(APPDATA)\nushell"
