...
if v:true
    ...
    function! CommandlinePre() abort
        ...
        if getcmdtype() == '/'
            call ddc#custom#patch_global('cmdlineSources', ['buffer', 'cmdline-history'])
        elseif getcmdtype() == '#'
            call ddc#custom#patch_global('cmdlineSources', ['buffer'])
        else
            call ddc#custom#patch_global('cmdlineSources', ['cmdline', 'buffer'])
        endif
...
call ddc#custom#patch_global('filterParams', {
      ...
      \ 'postfilter_score': {
      \   'excludeSources': ["dictionary", "emoji"],
      \ },
      \ })
